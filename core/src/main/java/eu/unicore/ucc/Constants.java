...
public interface Constants {
	...
	public static final String OPT_WAIT_LONG = "wait-for";
	...
	// properties key for the "working directory of the last job"
	public static final String PROP_LAST_JOBDIR_URL = "_job_dir";
